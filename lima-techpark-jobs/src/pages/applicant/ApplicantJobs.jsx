...
import { getJobs, getCompanies, submitApplication } from '../../lib/db';
...
export default function ApplicantJobs() {
  ...
  return (
    <div className="pw">
      <div className="ph"><h2>Open Positions</h2><p>All roles are at companies physically located inside Lima Techno Park.</p></div>
      ...
      <div className="split" style={{ gridTemplateColumns: '315px 1fr' }}>
        <div className="jlist">
          {filtered.length > 0 ? filtered.map(j => (
            ...
            <div style={{ padding: '2.5rem', textAlign: 'center', color: 'var(--text3)', fontSize: '.8rem' }}>No jobs match your search.</div>
          )}
        </div>
            ...
            <>
              <div className="dp-head">
                ...
                <div>
                  ...
                  <div className="dp-co">{selectedJob.co} · Lima Techno Park</div>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="fgroup">
              ...
              <div className="upload-zone">
                ...
                <div className="uz-text"><strong>Click to upload</strong> or drag & drop</div>
                <div className="uz-hint">PDF or DOCX · Max 5MB</div>
              </div>
            </div>
            <div className="fgroup">
              <label className="flabel">Portfolio <span style={{ color: 'var(--text3)', fontSize: '.68rem', textTransform: 'none', letterSpacing: 0, fontWeight: 400 }}>(optional)</span></label>
              <div className="upload-zone">
                <input type="file" accept=".pdf,.doc,.docx,.zip" />
                <div className="uz-icon">📎</div>
                <div className="uz-text"><strong>Click to upload</strong> or drag & drop</div>
                <div className="uz-hint">PDF, DOCX, or ZIP · Max 10MB</div>
              </div>
            </div>

            <div className="msep">Cover letter</div>
            <div className="fgroup">
              <textarea id="apply-cover" className="ftextarea" placeholder="Tell us why you're a great fit for this role…" style={{ minHeight: 95 }} />
            </div>

            <button className="btn-primary" onClick={() => handleApply(modal.data.id)}>Submit application →</button>
          </div>
        )}
      </Modal>
